...
export default function FooterSection() {
    return (
        <footer className="py-8 md:py-16 bg-white">
            <div className="mx-auto max-w-4xl px-4">
                ...
                <div className="my-4 flex flex-wrap justify-center gap-4 text-xs">
                    {links.map((link, index) => (
                        <Link
                            key={index}
                            href={link.href}
                            className="text-gray-500 hover:text-[#104c66] block duration-150">
                ...
                <div className="my-4 flex flex-wrap justify-center gap-4 text-xs">
                    <Link
                        ...
                        className="text-gray-500 hover:text-[#104c66] block">
                        <svg
                            className="size-4"
                ...
                <span className="text-gray-500 block text-center text-xs pb-2"> &copy; {new Date().getFullYear()} Zan Orthodontics, All rights reserved</span>
            </div>
        </footer>
    )
}
